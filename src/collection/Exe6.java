package collection;
/*
 * create a method which accepts the ID of the age of the people as the map and decide
 *  if they are eligible for vote. A person is eligible for vote if his age is greater than
 *   18 add the ID's of the All The Eligible persons to list and return the list
 */
