...
/*
 * write a class which main method to demonstrate instance creation using 
 * method instant (hint- create any simple class with attributes and getter and setter)
 */
...
public class Exe4 {
	...
	public  Exe4(int id, String name, float marks1, float marks2, float marks3) {
		super();
		this.id = id;
		this.name = name;
		this.marks1 = marks1;
	...
	public static void main(String[] args)
	{
		...
		while(math_marks<0 || math_marks>100);
		 Exe4 stdm=new  Exe4(id, name, phy_marks, chem_marks, math_marks);
